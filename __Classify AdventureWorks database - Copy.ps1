$authToken = "NjI5MzA1ODU4OTkxMzI1MTg0OjMwYzllYzc5LThhOWMtNGYzMi1hYmQ5LTFiMmFiYTA2ZWM3NA=="
$serverUrl = "http://localhost:15156" # or https:// if you've configured SSL
$instanceName = '(local)\sql2014'
$databaseName = 'AdvWorksVagrant'
...
$systemColumns = $allColumns | `
        Where-Object { $_.tableName -like "*Build*" -or $_.tableName -like "*Database*" `
            -or $_.tableName -like "*Error*" -or $_.columnName -like "*ModifiedDate*" `
...
$employeeColumns = $allColumns | `
        Where-Object { $_.columnName -eq 'Resume' -or $_.columnName -like '*SickLeave*' `
            -or $_.tableName -like '*PayHistory*' -or $_.tableName -eq 'Shift' `
            -or $_.columnName -like '*Marital*' -and $_.columnName -ne 'RateChangeDate' }
